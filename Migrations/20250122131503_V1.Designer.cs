...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Studenti.Models.IspitniRok", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Studenti.Models.Predmet", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Studenti.Models.Spoj", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Studenti.Models.Spoj", b =>
                {
                    b.HasOne("Studenti.Models.IspitniRok", "IspitniRok")
                        .WithMany("StudentiPredmeti")
                        .HasForeignKey("IspitniRokID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Studenti.Models.Predmet", "Predmet")
